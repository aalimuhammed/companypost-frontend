    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(circle, #1e40af 0%, transparent 70%)', filter: 'blur(40px)' }}
        />
        <div
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(90deg, #1d4ed8 0%, #0ea5e9 50%, #1d4ed8 100%)' }}
        />
        ...
        <div className="px-8 pt-8 pb-10">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="flex items-center gap-2 mt-4 w-full">
              ...
              <div className="w-1.5 h-1.5 rounded-full" style={{ background: '#3b82f6', opacity: 0.6 }} />
              <div className="flex-1 h-px" style={{ background: 'rgba(59,130,246,0.15)' }} />
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl px-4 py-3 text-left text-sm outline-none transition-all duration-200"
                  style={{
                  ...
                  onBlur={(e) => {
                    e.currentTarget.style.border = '1px solid rgba(71,85,105,0.6)';
                    e.currentTarget.style.boxShadow = 'none';
                  }}
                />
                <span className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: '#475569' }}>
